...
$CON=$CON+1;
 $sub_array = array();
 $sub_array[] = '<div contenteditable data-id="'.$row["NOMBRE_REPRESENTANTE"].'"'. $CON .' data-column="NOMBRE_REPRESENTANTE">' . $row["NOMBRE_REPRESENTANTE"] . '</div>';
$sub_array[] = '<div contenteditable data-id="'.$row["NOMBRE_EMPRESA"].'"'. $CON .' data-column="NOMBRE_EMPRESA">' . $row["NOMBRE_EMPRESA"] . '</div>';
$sub_array[] = '<div contenteditable data-id="'.$row["RTN"].'"'. $CON .' data-column="RTN">' . $row["RTN"] . '</div>';
$sub_array[] = '<div contenteditable data-id="'.$row["TELEFONO"].'"'. $CON .' data-column="TELEFONO">' . $row["TELEFONO"] . '</div>';
$sub_array[] = '<div contenteditable data-id="'.$row["DIRECCION"].'"'. $CON .' data-column="DIRECCION">' . $row["DIRECCION"] . '</div>';
