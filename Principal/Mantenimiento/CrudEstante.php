...
<!--xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx-->
  ...
  <link rel="stylesheet" type="text/css" href="../css/maquinawrite.css">
    ...
    <?php
        ...
        $sqlCliente   = ("SELECT * FROM TBL_ESTANTE");
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                          ...
                          <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteESTANTE<?php echo $dataCliente['COD_ESTANTE']; ?>">
                            ...
                            <?php include('Estante_Modal_Eliminar.php'); ?>


                            <!--Ventana Modal para Actualizar--->
                            <?php  include('Estante_Modal_Editar.php'); ?>
...
//Ocultar mensaje
    ...
    $('.btnBorrar').click(function(e){
        ...
        var dataString = 'COD_ESTANTE='+ id;
        url = "Estante_recib_Delete.php";
            $.ajax({
                type: "POST",
                url: url,
                data: dataString,
                ...
                {
                  window.location.href="CrudEstante.php";
                  $('#respuesta').html(data);
                }
            });
    return false;
