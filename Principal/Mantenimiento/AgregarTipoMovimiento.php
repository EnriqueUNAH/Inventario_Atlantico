...
<head>
    <meta charset="UTF-8">
    <title>Agregar Nuevo Tipo Movimiento</title>
...
<body>
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mt-5">Agregar Nuevo Tipo Movimiento</h2>
                    <p>Por favor llenar este formulario para agregar un nuevo tipo de movimiento a la base.</p>
                    <form action="InsertarTipoMovimiento.php" method="post">

                    <div class="col-12">
                      <label for="yourName" class="form-label">Codigo tipo de movimiento</label>
