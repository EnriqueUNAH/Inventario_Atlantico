...
<!-- Change Password Form -->
    ...
    <form action="Objetos_create.php" method="post" onsubmit="validatePassword(); return false;" class="row g-3 needs-validation" novalidate="false">
    ...
    <div class="col-8">
      ...
      <div class="col-8">
        ...
        <div class="invalid-feedback">POR FAVOR, INGRESA UNA DESCRIPCION!</div>
      </div>

      <div class="col-8">
        <label for="yourName" class="form-label">TIPO OBJETO:</label>
        <input type="text" style="text-transform:uppercase" name="TIPO_OBJETO"  class="form-control" id="yourName" required>
        <div class="invalid-feedback">POR FAVOR, INGRESA UN TIPO DE OBJETO!</div>
      </div>
      ...
      <div class="text-center">
        <div class="form-group">
          ...
          <a href="CrudObjetos.php" class="btn btn-sm btn-danger">Cancelar</a>
          </div>
        </div>
      </div>
