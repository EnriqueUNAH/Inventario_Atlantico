...
<body>
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mt-5">Actualizar Pregunta</h2>
                    <p>Por favor llenar este formulario para actualizar la pregunta en la base.</p>
                    <form action="Pregunta-Update.php" method="post">
