                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                          ...
                          <td> 
                          <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteChildresn<?php echo $dataCliente['ID_PREGUNTA']; ?>">
                                  Eliminar
                              </button>
                            
                            
                              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editChildresn<?php echo $dataCliente['ID_PREGUNTA']; ?>">
                                  Modificar
                              </button>
                          </td>
                          </tr>
                            ...
                            <?php include('ModalEliminarPregunta.php'); ?>


                            <!--Ventana Modal para Actualizar--->
                            <?php  include('ModalEditarPregunta.php'); ?>
