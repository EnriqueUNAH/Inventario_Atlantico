...
<script>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>AÑADIR NUEVO ESTADO</h1>
        </ol>
      </nav>
    </div><!-- End Page Title -->
<!-- Change Password Form -->

    <form action="Estado_create.php" method="post" onsubmit="validatePassword(); return false;" class="row g-3 needs-validation" novalidate="false">

    <div class="col-8">
        <label for="yourName" class="form-label">NOMBRE ESTADO:</label>
        <input type="text" style="text-transform:uppercase" name="NOMBRE_ESTADO"  class="form-control" id="yourName" required>
      ...
      <div class="text-center">
        <div class="form-group">
          ...
          <a href="CrudEstado.php" class="btn btn-sm btn-danger">Cancelar</a>
          </div>
        </div>
      </div>
