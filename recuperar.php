              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action="validar.php" method="post" class="row g-3 needs-validation" novalidate="false">
                    ...
                    <div class="col-12">
                      <button action="preguntas_recuperar.php" method="post" class="btn btn-primary w-100" type="submit" name="btnCorreo">ENVIAR CONTRASEÑA POR CORREO ELECTRONICO</button>
                    </div>
